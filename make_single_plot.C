...
void overlayHistograms(const char* dataFile, const char* mcFile, const char* outputFile) {
    // root files
    ...
    mcHistogram_pass->GetXaxis()->SetTitle("N vertices");
    ...
    mcHistogram_fail->GetXaxis()->SetTitle("N vertices");
    ...
    text_fail->SetTextSize(0.05);
    text_fail->DrawLatex(0.45, 0.93, "Failing");
...
void make_single_plot() {

    //overlayHistograms("/eos/user/m/mibarbie/2023_nVertices_our/flat/muon/standAloneMuons/Z/Run2023/Run2023/Nominal/NUM_SAMatched_DEN_StandAloneMuons_pt_onebin_eta_onebin_phi_onebin.root", "/eos/user/m/mibarbie/2023_nVertices_our/flat/muon/standAloneMuons/Z/Run2023/DY_madgraph/Nominal/NUM_SAMatched_DEN_StandAloneMuons_pt_onebin_eta_onebin_phi_onebin.root", "/afs/cern.ch/user/m/mibarbie/spark_tnp/2023_nVertices.png");
    overlayHistograms("/eos/user/m/mibarbie/2022_nVertices/flat/muon/standAloneMuons/Z/Run2022/Run2022/Nominal/NUM_SAMatched_DEN_StandAloneMuons_pt_onebin_eta_onebin_phi_onebin.root", "/eos/user/m/mibarbie/2022_nVertices/flat/muon/standAloneMuons/Z/Run2022/DY_madgraph/Nominal/NUM_SAMatched_DEN_StandAloneMuons_pt_onebin_eta_onebin_phi_onebin.root", "/afs/cern.ch/user/m/mibarbie/spark_tnp/2022_nVertices.png");
}
