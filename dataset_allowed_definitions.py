...
def get_allowed_sub_eras(resonance, era):
    subEras = {
            'Z': {
                ...
                # Run2023
                'Run2023': ['Run2023'] + [
                    f'Run2023{b}' for b in 'BCD']+['DY_madgraph'],
            },
            'JPsi': {
                # ultra legacy
                'Run2016_UL_HIPM': ['Run2016_UL_HIPM'] + [
...
def get_data_mc_sub_eras(resonance, era):
    eraMap = {
            'Z': {
                ...
                'Run2022_EE': ['Run2022_EE', 'DY_madgraph', 'DY_madgraph'],
                'Run2023': ['Run2023', 'DY_madgraph'],
            ...
            'JPsi': {
                ...
                # Run2022
                'Run2022'   : ['Run2022', 'JPsi_pythia8'],
                'Run2022_EE': ['Run2022', 'JPsi_pythia8'],
                # Run2023
                'Run2023'     : ['Run2023', 'JPsi_pythia8'],
                'Run2023_BPix': ['Run2023', 'JPsi_pythia8'],
            },
    }
